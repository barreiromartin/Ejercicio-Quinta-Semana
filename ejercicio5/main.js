...
function updateHTML(usuario){
    let nombre_1, email_1, direccion_1, telefono_1;

    nombre_1 = document.getElementById("nombre_1");
    email_1 = document.getElementById("email_1");
    direccion_1 = document.getElementById("direccion_1");
    telefono_1 = document.getElementById("telefono_1");
   

    nombre_1.innerHTML = "Nombre: " + usuario.getNombre();
    email_1.innerHTML = "Email: " + usuario.getEmail();
    direccion_1.innerHTML = "Dirección: " + usuario.getDireccion();
    telefono_1.innerHTML = "Teléfono: " + usuario.getTelefono();
